...
import Resume from '../assets/Hong_Taewoo_Resume.pdf'
        ...
        <div>
            <AiOutlineMenu onClick={handleNav} className='fixed top-4 right-4 z-[100] md:hidden' color='white' />
            {
                nav ? (
                    <div className='fixed w-full h-screen bg-white/90 flex flex-col justify-center items-center z-[99]'>
                        ...
                        <a onClick={handleNav} href={Resume} rel='noopener noreferrer' target='_blank' className='w-[75%] flex justify-center items-center rounded-full show-lg bg-gray-200 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-200 hover:bg-gray-300'>
                            <GrProjects size={20} />
            ...
            <div className='md:block hidden fixed top-[50%] translate-y-[-50%] right-4 z-10'>
                <div className='flex flex-col'>
                    <a title='Home' href='#main' className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
                        <AiOutlineHome size={20}/>
                    </a>
                    <a title='About' href='#about' className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
                        <BsPerson size={20}/>
                    </a>
                    <a title='Projects' href='#projects' className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
                        <AiOutlineProject size={20}/>
                    </a>
                    <a title='Resume' href={Resume} rel='noopener noreferrer' target='_blank'  className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
                        <GrProjects size={20}/>
                    </a>
                    <a title='Contact' href='#contact' className='rounded-full shadow-lg bg-gray-100 shadow-gray-400 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
                        <AiOutlineMail size={20}/>
                    </a>
                </div>
            </div>
