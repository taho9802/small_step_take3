    ...
    return (
        <div id='projects' className="w-full md:pl-1 py-16">
            <div className="max-w-[1000px] m-auto">
                <div className="md:block flex flex-col justify-center lg:justify-end items-center pl-4 pr-4">
                    <h1 className="md:text-4xl text-3xl font-bold text-right text-black">Projects</h1>
                    <div className="flex justify-end">
                        <span className="w-[200px] mt-4 mb-4 justify-end bg-black block h-[2px]"></span>
                    </div>
                    <p className="text-black text-right inline-block md:text-2xl text-1xl md:pl-1 md:w-[100%] w-[70%]">
