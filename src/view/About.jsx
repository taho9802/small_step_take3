...
const About = () => {
    return (
        <div id="about" className="w-full md:pl-1 py-16 bg-black">
            <div className="max-w-[1000px] md:block flex m-auto flex-col justify-center pl-4 pr-4 lg:items-start items-center">
                ...
                <span className="w-[200px] bg-white block h-[2px] mt-4 mb-4"></span>
                <img src={headshot} className="w-[25%] rounded-full inline-block float-right"/>
